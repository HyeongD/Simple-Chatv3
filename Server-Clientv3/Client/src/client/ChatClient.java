    ...
    public void handleMessageFromClientUI(String message) {
        ...
        if (message.startsWith("#help") || message.startsWith("#?")) {
            clientUI.display("\nClient-side command list: "
                    ...
                    + "n#unblock <loginID> -- Unblock messages from the specific client."
        ...
        if ((!(message.startsWith("#"))) || message.startsWith("#whoison") || message.startsWith("#private")
                || message.startsWith("#channel") || message.startsWith("#pub") || message.startsWith("#nochannel")
                || message.startsWith("#getchannel") || message.startsWith("#fwd") || message.startsWith("#unfwd")
                || message.startsWith("#block") || message.startsWith("#unblock") || message.startsWith("#whoiblock")
